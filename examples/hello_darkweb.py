...
txtorcon.IProgressProvider(ep)\
    .add_progress_listener(lambda p, tag, msg: print(msg))
ep.listen(server.Site(res))\
    .addCallback(lambda port: print(str(port.getHost()))).addErrback(print)
